 ...
 * O métod validar deve retornar null se o objeto estiver válido, e uma mensagem pertinente (ver abaixo)
 ...
 *
 * public String incluir(Acao acao): deve chamar o métod validar. Se ele
 ...
 *
 * public String alterar(Acao acao): deve chamar o métod validar. Se ele
...
public class MediatorAcao {
    ...
    private String validar(Acao acao) {
        ...
        if (acao.getNome() == null || acao.getNome().isBlank() || acao.getNome().isEmpty()) {
